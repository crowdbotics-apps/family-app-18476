export const installed_blueprints = [
  //@BlueprintInsertion
{ name: 'Settings72280', human_name: 'Settings', access_route: 'Settings72280'},
{ name: 'Messaging272276', human_name: 'Messaging 2', access_route: 'Messaging272276', icon: 'comments'},
